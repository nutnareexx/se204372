...
<center>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo "$p2->start_p - $p2->finish_p";?></td>
        </tr>
        <tr>
            <th align="right">ผลการอนุมัติ : </th>
            <td><?php echo "$p2->status_name";?></td>
        </tr>
    </table>
