...
class petitionCModel{
    ...
    $c_id, $compNo_p, $compRoad_p, $compSubdist_p, $compDistrict_p, $compProvince_p, $compPost_p, $hrName_p, $hrSname_p,
    ...
    public static function get($petition_id)
    {
        ...
        u.user_surname, p.FB_p, p.phone_p, p.position_p, p.approverName_p, p.approverSname_p, p.approverP_p, p.c_id, c.c_name, 
        ...
        NATURAL JOIN `detail_cooperative` AS c
  ...
  public static function search($key)
    {
        ...
        WHERE (p.petition_id like '%$key%' or p.date_p like '%$key%' or p.academicY_p like '%$key%' or p.user_id like '%$key%'
                    ...
                    or p.approverP_p like '%$key%' or p.c_id like '%$key%' or c.c_name like '%$key%' or p.compNo_p like '%$key%' or p.compRoad_p like '%$key%' 
                    ...
                    or s.status_id like '%$key%' or s.status_name like '%$key%' or p.approve_id like '%$key%')
                    ORDER BY p.academicY_p";
        $result = $conn->query($sql);
        while($my_row = $result->fetch_assoc())
        {
    ...
    public static function addC_old($date,$userid,$y,$faceB,$phone,$position,$approve_name,$approve_lastname,$approve_position,$company_id,$company_no,$company_road,$company_sub,$company_dis,$company_prov,$company_code,$hr_name,$hr_lastname,$hr_phone,$hr_mail,$pay,$room,$start,$finish){
        require("connection_connect.php");
        $sql = "INSERT INTO `petition`( `date_p`, `user_id`, `academicY_p`,`FB_p`, `phone_p`,`position_p`, 
                                        `approverName_p`, `approverSname_p`, `approverP_p`, 
                                        `c_id`, `compNo_p`, `compRoad_p`, `compSubdist_p`, `compDistrict_p`, `compProvince_p`, `compPost_p`, 
    ...
    public static function addC_new($date,$userid,$y,$faceB,$phone,$position,$approve_name,$approve_lastname,$approve_position,$company_name,$company_no,$company_road,$company_sub,$company_dis,$company_prov,$company_code,$hr_name,$hr_lastname,$hr_phone,$hr_mail,$pay,$room,$start,$finish){
        require("connection_connect.php");
        $sql = "INSERT INTO `petition`( `date_p`, `user_id`, `academicY_p`,`FB_p`, `phone_p`, `position_p`,
                                        `approverName_p`, `approverSname_p`, `approverP_p`, 
    ...
    public static function getAllupS()
    {
        $petionCList = [];
        require("connection_connect.php");
        $sql = "SELECT p.petition_id, DATE_FORMAT(p.date_p,'%d/%m/%Y') AS dt, p.academicY_p, p.user_id, nt.name_title, u.user_name, 
    ...
    public static function getAlldownS()
    {
        $petionCList = [];
        require("connection_connect.php");
        $sql = "SELECT p.petition_id, DATE_FORMAT(p.date_p,'%d/%m/%Y') AS dt, p.academicY_p, p.user_id, nt.name_title, u.user_name, 
