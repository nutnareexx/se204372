...
class petitionDcUserModel{
    ...
    public static function get($petition_id)
    {
        ...
        return new petitionDcUserModel($dc_id, $petition_id, $user_id, $name_title, $user_name, $user_surname, $start_p, $finish_p, 
        $dc_position,$dc_name, $dc_pay, $dc_room, $status_id, $status_name, $c_id);
    }
    ...
    public static function getAll()
    {
        ...
        while($my_row = $result->fetch_assoc())
        {
            ...
            $status_name = $my_row['status_name'];
            $c_id = $my_row['c_id'];
            $petionDcList[] = new petitionDcUserModel($dc_id, $petition_id, $user_id, $name_title, $user_name, $user_surname, $start_p, $finish_p, 
            $dc_position,$dc_name, $dc_pay, $dc_room, $status_id, $status_name, $c_id);
  ...
  {
      require("connection_connect.php");
      $sql = "DELETE FROM `petition` WHERE prtition = '$petition_id'";
      $result = $conn->query($sql);
      require("connection_close.php");
